...
public interface IBOAnchor extends IByteObject {
   ...
   /**
    */
   int ANCHOR_BASIC_SIZE                = A_OBJECT_BASIC_SIZE + 3;
   int ANCHOR_FLAG_1_INCOMPLETE         = 1 << 0;
   /**
    * When set, horiz value is null/undefined for merge purposes.
    * <br>
    */
   int ANCHOR_FLAG_7_DEF_HORIZ_ALIGN    = 1 << 6;
   /**
    * Existence flag for Vertical Alignement definition
    */
   int ANCHOR_FLAG_8_DEF_VERT_ALIGN     = 1 << 7;
   /**
    * Existence flag
    */
   int ANCHOR_OFFSET_01_FLAG            = A_OBJECT_BASIC_SIZE;
   /**
    ...
    * 
    */
   int ANCHOR_OFFSET_02_HORIZ_ALIGN1    = A_OBJECT_BASIC_SIZE + 1;
   /**
    ...
    */
   int ANCHOR_OFFSET_03_VERTICAL_ALIGN1 = A_OBJECT_BASIC_SIZE + 2;
