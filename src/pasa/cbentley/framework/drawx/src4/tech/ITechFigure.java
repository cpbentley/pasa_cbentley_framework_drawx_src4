...
public interface ITechFigure extends ITechByteObject {
   public static final int ALIGN_2BITS_0CENTER                  = 0;

   public static final int ALIGN_2BITS_1LEFT                    = 1;

   public static final int ALIGN_2BITS_1TOP                     = 1;

   public static final int ALIGN_2BITS_2BOT                     = 2;

   public static final int ALIGN_2BITS_2RIGHT                   = 2;
    ...
    */
   public static final int FIG_FLAG_7SUB_FIGURE                 = 64;
    ...
    * 
    */
   public static final int FIG_FLAG_8TBLR_DIR                   = 128;
   ...
   public static final int FIG_PIXEL_OFFSET_07_LENGTH_H2        = FIG__BASIC_SIZE + 1;

   public static final int FIG_PIXEL_OFFSET_08_LENGTH_V2        = FIG__BASIC_SIZE + 1;

   public static final int FIG_PIXEL_OFFSET_09_GRAD_SIZE1       = FIG__BASIC_SIZE + 1;
    ...
    */
   public static final int FIG_STRING_FLAG_1SCALING             = 1;

   public static final int FIG_STRING_FLAG_4RAW                 = 8;
    ...
    */
   public static final int FIG_STRING_FLAG_5EFFECT              = 16;

   /**
    * Set if a RawType string is present.
    * Must check for {@link ITechFigure#FIG_STRING_FLAG_7CHAR} or  {@link ITechFigure#FIG_STRING_FLAG_4RAW}
    * <br>
    * <br>
    * 
    */
   public static final int FIG_STRING_FLAG_6EXPLICIT            = 32;

   /**
    * Figure is just one char defined at {@link ITechFigure#FIG_STRING_OFFSET_5CHAR2}.
    * <br>
    * <br>
    * Text effect are applied
    */
   public static final int FIG_STRING_FLAG_7CHAR                = 64;
    ...
    */
   public static final int FIG_STRING_OFFSET_3STYLE1            = FIG__BASIC_SIZE + 2;

   /**
    * MM: flag 3 of offset 6.
    * <br>
    * <br>
    * <li>{@link IMFont#SIZE_4_LARGE} 16
    * <li>{@link IMFont#SIZE_3_MEDIUM} 0
    * <li>{@link IMFont#SIZE_2_SMALL} 8
    * <br>
    * <br>
    ...
    * 
    */
   public static final int FIG_STRING_OFFSET_4SIZE1             = FIG__BASIC_SIZE + 3;

   /**
    * Character Unicode. <br>
    * Often used with a scaler to draw big numbers. Centered and scaled on the drawing area
    */
   public static final int FIG_STRING_OFFSET_5CHAR2             = FIG__BASIC_SIZE + 4;
    ...
    * 
    */
   public static final int FIG_STRING_OFFSET_6SCALE1            = FIG__BASIC_SIZE + 6;

   /**
    * Number of dynamic text effects. i.e. differiante from static text effects.
    * <br>
    * <br>
    * Convenience that counts subs which have the flag {@link IFxStr#FX_FLAGX_2_DYNAMIC}
    * <br>
    * <br>
    * 
    */
   public static final int FIG_STRING_OFFSET_7NUM_DYNAMIC1      = FIG__BASIC_SIZE + 7;
